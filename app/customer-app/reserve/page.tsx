...
const mainMenus = [
  ...
  { id: "color_gradation", label: "カラーグラデーション", price: 3000, minutes: 90 },
  { id: "french", label: "フレンチネイル", price: 6000, minutes: 120 },
  { id: "magnet_one_color", label: "マグネットワンカラー", price: 3000, minutes: 90 },
  { id: "free_90", label: "90分やり放題", price: 5700, minutes: 120 },
  { id: "free_120", label: "120分やり放題", price: 7500, minutes: 150 },
  {
    id: "free_120_parts",
...
function ReservePageContent() {
  ...
  const maxReservationDate = useMemo(() => addDaysText(todayText, 30), [todayText]);
